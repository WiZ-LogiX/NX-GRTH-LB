...
export function FaqSection() {
  ...
  const faqs = [
    ...
    {
      q: "كيف يتم الاشتراك والحصول على الدليل كهدية؟",
      a: "الاشتراك يتم بخطوات بسيطة عبر التواصل المباشر. اضغط على زر «تواصل معنا»، وسيتحدث معك فريقنا لتوضيح كافة تفاصيل الاشتراك وإتمام الإجراءات معك وتفعيل وصولك المباشر لمنظومة Nux Growth AI Guide كاملة كهدية متضمنة.",
    },
  ];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center space-y-4 mb-16">
          ...
          <h2 className="text-3xl sm:text-5xl font-black tracking-tight text-foreground leading-tight">
            ...
            <span className="text-primary">عن الدليل والاشتراك والتواصل</span>
          </h2>
